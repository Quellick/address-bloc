require_relative '../models/entry'
 # #1 standard first line of an RSpec test. We are saying that the file is a spec file and that it tests 'Entry'
 RSpec.describe Entry do
   ...
   describe "attributes" do
     ...
     it "responds to name" do
       # #4 RSpec test ends with one or more expect method, which we use to declare the expectations for the test. If those expectations are met, our test passes, if they are not, it fails
